...
import 'package:beauty_shopping_application/widgets/image_swipe.dart';
import 'package:beauty_shopping_application/widgets/product_size.dart';
          ...
          FutureBuilder(
            ...
            builder: (context, snapshot) {
              ...
              if (snapshot.connectionState == ConnectionState.done) {
                ...
                List productSizes = documentData['shade'];

                // Set an initial size
                _selectedProduct = productSizes[0];
